...
import static de.nls.examples.microscope.Microscope.*;
import static de.nls.examples.microscope.Microscope.LED.*;
...
public class LanguageControl {
	...
	public Parser initParser() {
		...
		parser.defineType("led", "385nm", e -> LED_385);
		parser.defineType("led", "470nm", e -> LED_470);
		parser.defineType("led", "567nm", e -> LED_567);
		parser.defineType("led", "625nm", e -> LED_625);
